...
let ProductService = class ProductService {
    constructor(httpClient) {
        ...
        this.url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].backend_api_url;
    }
    getAllProducts(pageNumber = 1) {
        return this.httpClient.get(`${this.url}/products?per_page=100&hide_empty=true&parent=0`);
    }
    getSingleProduct(id) {
        return this.httpClient.get(`${this.url}/products/${id}`);
    }
    searchProducts(keyword) {
        return this.httpClient.get(`${this.url}/products?search=${keyword}`);
    }
    getAllCategories() {
        return this.httpClient.get(`${this.url}/products/categories?per_page=100&hide_empty=true&parent=0`);
    }
};
...
let CartService = class CartService {
    ...
    constructor(httpClient, loadingController, alertController, toastController, storage, router) {
        this.httpClient = httpClient;
        ...
        this.cartData$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"]({ count: 0, productData: [] });
        this.totalAmount = 0;
    ...
    createOrder(orderData) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().set(_backend_interceptor__WEBPACK_IMPORTED_MODULE_8__["WriteObject"], '');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div id=\"container\">\n  <p><strong>Iniciaste Sesion Como Invitado</strong></p>\n</div>\n");
